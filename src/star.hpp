...
class Star {
  ...
  public:
    Star(int x = randInt(0, 4000), int y = randInt(0, 4000), int temperatureK = randInt(2300, 10000), double solarRadius = randFloat(0.3, 12), double distance = randFloat(0.5, 400));
    int getX();
    int getY();
    int getTemperature();
